...
comparison.to_csv("bangaluru_weather_prediction_results.csv", index=False)
print("\n💾 Saved results to: bangaluru_weather_prediction_results.csv")

# -------------------------------------------------------
# 9️⃣ SAVE TRAINED MODEL
# -------------------------------------------------------
dump(model, "bangaluru_weather_model.pkl")

print("🤖 Model saved as: bangaluru_weather_model.pkl")
